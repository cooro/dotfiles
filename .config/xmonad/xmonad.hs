...
myWorkspaces    = ["web","dev","doc","vid","irc","gfx","exo","exp"]
...
mySpacing = spacingRaw False                -- disable spacing for single window
                       (Border  5 10 40 30) -- screen edge gap size
...
myKeys = 
    ...
    , ("M-;", spawn "rofi -show run")            -- Launch a Prompt
    ...
    , ("M-r", sendMessage $ JumpToLayout "Fullscreen")              -- Switch to Fullscreen layout
